...
export default function Dashboard(){
    ...
    const fetchData = async () => {
        ...
        return (
           <div className="flex bg-gray-300 h-full font-mono text-base">
                <div className="flex-row w-1/4 bg-gray-300">
                    <div className="flex-col mx-2 my-6 px-8 py-4 bg-blue-200 hover:bg-blue-300 transition duration-300 rounded-2xl shadow-xl text-gray-800 hover:cursor-pointer text-center">
                ...
                <div className="flex-col mx-2 my-6 px-8 py-4 bg-blue-300 rounded-2xl shadow-xl text-gray-800" key={key}>
                    ...
                    {typeof value === 'object' && value !== null && !Array.isArray(value) ? (
                        ...
                        Object.entries(value).map(([key1, val]) => (
                            <div key={key1}>
                                ...
                                <table>
                                    <tbody>
                                        <tr className="bg-blue-300 even:bg-blue-100">
